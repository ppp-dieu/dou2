    ...
    const openAiResponse = await fetch("https://api.openai.com/v1/responses", {
      ...
      body: JSON.stringify({
        ...
        instructions: [
          ...
          "eventsは3候補作成してください。事実を変えず、感情・推測・評価・解決策を追加しないでください。最終出力は各55文字以内にしてください。",
          role === "respondent"
            ? "feelingsは3候補作成し、各候補にはこの相談で最も中心となる気持ちを1つだけ含めてください。複数の感情を無理に抽出しないでください。候補ごとに別の感情を創作する必要はなく、同じ中心的な気持ちについて焦点や表現を変えて構いません。回答者本人の発言、または回答者が会話の中で明確に肯定した内容だけを根拠にしてください。最終出力は必ず「感情名：本文」とし、感情名は1〜4文字、本文は30文字以内にしてください。"
            : "feelingsは3候補作成し、各候補にはこの相談で最も中心となる気持ちを1つだけ含めてください。複数の感情を無理に抽出しないでください。候補ごとに別の感情を創作する必要はなく、同じ中心的な気持ちについて焦点や表現を変えて構いません。相談者本人の発言、または相談者が会話の中で明確に肯定した内容だけを根拠にしてください。最終出力は必ず「感情名：本文」とし、感情名は1〜4文字、本文は30文字以内にしてください。",
          role === "respondent"
            ? "wishesは3候補作成してください。回答者本人が話した、パートナーにしてほしいこと・依頼したいことだけを使用してください。新しい解決策や希望を追加しないでください。最終出力は各38文字以内にしてください。"
            : "wishesは3候補作成してください。相談者本人が話した、パートナーにしてほしいこと・依頼したいことだけを使用してください。新しい解決策や希望を追加しないでください。最終出力は各38文字以内にしてください。",
