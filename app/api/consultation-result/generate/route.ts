    ...
    const openAiResponse = await fetch("https://api.openai.com/v1/responses", {
      ...
      body: JSON.stringify({
        ...
        instructions: [
          ...
          role === "respondent"
            ? "feelingsは3候補作成し、各候補にはこの相談で最も中心となる気持ちを1つだけ含めてください。複数の感情を無理に抽出しないでください。3候補は、それぞれ異なる感情または異なる引っかかりの可能性を示してください。単なる言い換えは禁止です。回答者本人の発言、または回答者が会話の中で明確に肯定した内容だけを根拠にしてください。最終出力は必ず「感情名：本文」とし、感情名は1〜4文字、本文は30文字以内にしてください。"
            : "feelingsは3候補作成し、各候補にはこの相談で最も中心となる気持ちを1つだけ含めてください。複数の感情を無理に抽出しないでください。3候補は、それぞれ異なる感情または異なる引っかかりの可能性を示してください。単なる言い換えは禁止です。相談者本人の発言、または相談者が会話の中で明確に肯定した内容だけを根拠にしてください。最終出力は必ず「感情名：本文」とし、感情名は1〜4文字、本文は30文字以内にしてください。",
          role === "respondent"
