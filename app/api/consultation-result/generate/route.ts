    ...
    const openAiResponse = await fetch("https://api.openai.com/v1/responses", {
      ...
      body: JSON.stringify({
        ...
        instructions: [
          ...
          "3候補は言い換えではなく、異なる仮説・解釈・着眼点として生成する。単なる語尾変更や同義語への置換にせず、候補ごとに別の事実、感情、希望を創作しないでください。",
          "各候補は、意味の重複を避ける",
          "まず入力された4組のQ&Aから、文字数を気にせず内容を整理してください。その整理内容をもとに、最終出力だけを以下の文字数・形式へ整えてください。途中の整理内容は出力せず、最終結果だけを返してください。",
          "相談内容から成立する複数の可能性を意図的に分岐させる",
          "eventsは3候補作成してください。本人が実際に発言した出来事・行動だけを書く。仮定、推測、解釈、願望、条件文を追加してはいけない。最終出力は各55文字以内にしてください。",
          role === "respondent"
            ? "feelingsは3候補作成し、各候補にはこの相談で最も中心となる気持ちを1つだけ含めてください。複数の感情を無理に抽出しないでください。3候補は、それぞれ異なる感情または異なる引っかかりの可能性を示してください。単なる言い換えは禁止です。回答者本人の発言、または回答者が会話の中で明確に肯定した内容だけを根拠にしてください。feelingsには、行動方針・判断・許容条件・解決策を書かないでください。本人が感じている感情や心理的な負担・迷い・抵抗感だけを表現してください。最終出力は必ず「感情名：本文」とし、感情名は1〜4文字、本文は30文字以内にしてください。"
            : "feelingsは3候補作成し、各候補にはこの相談で最も中心となる気持ちを1つだけ含めてください。複数の感情を無理に抽出しないでください。3候補は、それぞれ異なる感情または異なる引っかかりの可能性を示してください。単なる言い換えは禁止です。相談者本人の発言、または相談者が会話の中で明確に肯定した内容だけを根拠にしてください。feelingsには、行動方針・判断・許容条件・解決策を書かないでください。本人が感じている感情や心理的な負担・迷い・抵抗感だけを表現してください。最終出力は必ず「感情名：本文」とし、感情名は1〜4文字、本文は30文字以内にしてください。",
          role === "respondent"
            ? "wishesは3候補作成してください。回答者本人が話した、パートナーにしてほしいこと・依頼したいことだけを使用してください。3候補は、同じ希望の言い換えではなく、それぞれ異なる方向性の希望として作成してください。新しい解決策や希望を追加しないでください。最終出力は各38文字以内にしてください。"
            : "wishesは3候補作成してください。相談者本人が話した、パートナーにしてほしいこと・依頼したいことだけを使用してください。3候補は、同じ希望の言い換えではなく、それぞれ異なる方向性の希望として作成してください。新しい解決策や希望を追加しないでください。最終出力は各38文字以内にしてください。",
