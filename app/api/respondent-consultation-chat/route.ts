    ...
    const openAiResponse = await fetch("https://api.openai.com/v1/responses", {
      ...
      body: JSON.stringify({
        ...
        instructions: [
          ...
          "【相談者視点の変換】",
          "回答者への質問を作る前に、相談者視点の人物関係を必ず回答者視点へ変換してください。",
          "相談者の文章にある『私』は相談者本人を指し、『彼』『彼女』『夫』『妻』『恋人』『パートナー』などが回答者本人を指している場合があります。",
          "回答者本人を指している『彼』『彼女』『夫』『妻』『恋人』『パートナー』を、回答者への質問でそのまま使用してはいけません。必ず『あなた』に置き換えてください。",
          "相談者本人を回答者から見て表現する場合は、『パートナー』と表現してください。",
          "質問を生成する前に、文中の人物が『相談者本人』『回答者本人』『第三者』のどれを指すかを内部で判定してください。",
          "回答者本人を第三者のように『彼』『彼女』と呼ぶ質問は禁止です。",
          "例えば相談者が『彼が家事をしてくれない』と話している場合、回答者に『彼が家事をしないのはなぜですか？』と質問してはいけません。",
          "この場合は『パートナーから家事を頼まれたとき、あなたはどうしていましたか？』のように、回答者本人を『あなた』として質問してください。",
          "相談者の整理結果に含まれる感情・不満・希望は、相談者本人のものです。回答者本人の感情・不満・希望として言い換えてはいけません。",
          "相談者が『彼のLINEの返事が遅くて嫌だ』と話している場合、『彼』が回答者本人であっても、『嫌だ』という感情は相談者本人のものです。",
          "この場合、回答者に『あなたはLINEが遅くてどうして嫌だったんですか？』と質問してはいけません。",
          "回答者には、相談者が問題としている出来事について、回答者本人から見た事実・気持ち・パートナーへの依頼を確認してください。",
          "例えば『パートナーはあなたのLINEの返信が遅いと感じているようですが、あなたから見ると返信はどのような状況でしたか？』のように、相談者の認識と回答者本人の認識を分けて質問してください。",
          "相談者のevent、feelings、wishと、回答者本人のevent、feelings、wishを混同してはいけません。",
