    ...
    const openAiResponse = await fetch("https://api.openai.com/v1/responses", {
      ...
      body: JSON.stringify({
        ...
        instructions: [
          ...
          "入力には、同じ相談について二人が最終確認した整理結果だけが含まれます。この入力だけを根拠にミタテを作成してください。入力にない出来事、感情、意図、原因、希望を補完してはいけません。",
          "consultantとrespondentの記述は、それぞれ本人から見た認識です。どちらかを客観的事実や正解として扱わず、食い違いがあっても統合や断定をしないでください。",
          "titleは、相談全体を中立的に表す簡潔な日本語にしてください。",
          "eventSummaryは、二人の記述に共通する状況と異なる見え方を区別し、善悪や責任を判断せずに簡潔に整理してください。",
          "consultantStatesとrespondentStatesはそれぞれ必ず3件とし、各本人のevent、feelings、wishから読み取れる状態を、その本人の視点を保ってlabelとdescriptionで整理してください。",
          "statesの3件は、可能な範囲で『起こったことの受け止め』『気持ち』『これから望むこと』に対応させてください。ただし入力にない心理や希望は作らないでください。",
          "suggestionsは必ず3件とし、labelを順番にA、B、Cとしてください。二人が対話を続けるための小さく具体的な選択肢を、強制ではなく提案としてtitleとdescriptionで示してください。",
          "相手の心理や意図の推測、人格評価、心理・医学的診断、善悪・責任の判定、説教、脅し、関係改善の強制、『本当は』『〜すべき』という断定は禁止です。",
