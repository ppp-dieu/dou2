...
export default function RegisterStep2({
  ...
  return (
    <main className="flex h-dvh flex-col">
      {/* Header */}
      <header className="relative flex h-[18dvh] items-end justify-center px-6">
        <button
          type="button"
          onClick={onBack}
          aria-label="前の画面に戻る"
          className="absolute left-4 top-4 flex size-11 items-center justify-center text-[#49B8B1] transition-opacity active:opacity-60"
        >
          <svg
            viewBox="0 0 24 24"
            className="size-6"
        ...
        <div className="flex flex-col gap-8">
          <div className="flex flex-col gap-1">
            ...
            <select
              ...
              className="h-12 w-full rounded-md border border-[#6B7776] bg-white px-4 text-base text-[#1B3230] outline-none focus:border-[#49B8B1]"
            >
